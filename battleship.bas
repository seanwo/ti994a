...
1010 IF ERRVAL=1 THEN 950 :: REM GOTO DEPLOYMANSHIP
...
1270 IF ERRVAL=1 THEN 1160 :: REM GOTO DEPLOYCOMPSHIP
...
1590 IF WINNER=0 OR WINNER=1 THEN 1630 :: REM GOTO GAMEOVER
1600 CALL GETAUTOPLAY(AUTOPLAY)
1610 IF AUTOPLAY=0 THEN PLAYER=1-PLAYER
1620 GOTO 1540 :: REM GOTO TURNLOOP
...
1760 IF ERRVAL=1 THEN 1720 :: REM GOTO INPUTLOOP
1770 SUBEND
...
2100 IF QLEN=0 THEN GOSUB 2210 :: REM GOSUB EMPTYQUEUE
2110 IF QLEN=0 THEN GOTO 2160 :: REM GOTO VALIDATESHOT
2120 IF OFFSET=0 THEN GOSUB 2250 :: REM GOSUB OFFSETZERO
...
2180 IF ERRVAL=1 THEN OFFSET=0 :: GOTO 2080 :: REM GOTO AISTART
2190 OLDQLEN=QLEN
...
3680 IF AUTODEPLOY$="" THEN  3660 :: REM GOTO ASKAUTO
3690 SUBEND
...
4190 IF PLAYAGAIN$="" THEN  4170 :: REM GOTO ASKPLAYAGAIN
4200 SUBEND
...
4260 IF INPUTROW$="" THEN  4240 :: REM GOTO GETROW
4270 REM LABEL ***GETCOL***
4280 ACCEPT AT(ROW,COL-2+1)VALIDATE(DIGIT)BEEP SIZE(2):INPUTCOL
4290 IF INPUTCOL>10 THEN  4270 :: REM GOTO GETCOL
4300 IF INPUTCOL<1 THEN  4270 :: REM GOTO GETCOL
...
5430 IF VALUE=Q(I) THEN DINDEX=I :: GOTO 5460 :: REM GOTO CONTRACT
5440 NEXT I
