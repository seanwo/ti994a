...
1250 CALL COLOR (9,7,16)
1260 CALL COLOR (10,7,16)
1270 CALL COLOR (11,2,16)
1280 CALL COLOR (12,2,16)
1290 CALL COLOR (13,2,1)
1300 CALL COLOR (14,16,16)
1310 CALL SCREEN (3)
1320 SUBEND
...
1590 IF CARDVAL=2 THEN CALL RENDER2(ROW,COL,SUIT) :: GOTO 1720
1600 IF CARDVAL=3 THEN CALL RENDER3(ROW,COL,SUIT) :: GOTO 1720
1610 IF CARDVAL=4 THEN CALL RENDER4(ROW,COL,SUIT) :: GOTO 1720
1620 IF CARDVAL=5 THEN CALL RENDER5(ROW,COL,SUIT) :: GOTO 1720
1630 IF CARDVAL=6 THEN CALL RENDER6(ROW,COL,SUIT) :: GOTO 1720
1640 IF CARDVAL=7 THEN CALL RENDER7(ROW,COL,SUIT) :: GOTO 1720
1650 IF CARDVAL=8 THEN CALL RENDER8(ROW,COL,SUIT) :: GOTO 1720
1660 IF CARDVAL=9 THEN CALL RENDER9(ROW,COL,SUIT) :: GOTO 1720
1670 IF CARDVAL=10 THEN CALL RENDER10(ROW,COL,SUIT) :: GOTO 1720
1680 IF CARDVAL=11 THEN CALL RENDERJACK(ROW,COL,SUIT) :: GOTO 1720
1690 IF CARDVAL=12 THEN CALL RENDERQUEEN(ROW,COL,SUIT) :: GOTO 1720
1700 IF CARDVAL=13 THEN CALL RENDERKING(ROW,COL,SUIT) :: GOTO 1720
1710 IF CARDVAL=14 THEN CALL RENDERACE(ROW,COL,SUIT) :: GOTO 1720
1720 SUBEND
...
3340 DUP=0
3350 FOR I=0 TO 9
3360 IF DECK(I)=X THEN DUP=1 :: GOTO 3380
3370 NEXT I
3380 SUBEND
...
3510 IF SCORE+10>21 THEN 3550
3520 FOR I=0 TO CARDS(PLAYER)-1
3530 IF HANDS(PLAYER,I,0)=14 THEN SCORE=SCORE+10 :: GOTO 3550
3540 NEXT I
3550 SUBEND
